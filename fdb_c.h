 ...
 *
 * License: see https://foundationdb.com/license
 *
 * Documentation for this API can be found at
 * https://foundationdb.com/documentation/api-c.html
 *
...
#error You must #define FDB_API_VERSION prior to including fdb_c.h (current version is 200)
#elif FDB_API_VERSION < 13
#error API version no longer supported (upgrade to 13)
#elif FDB_API_VERSION > 200
